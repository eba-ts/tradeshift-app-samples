...
public class ApiClient {
    ...
    private String basePath = "https://api-sandbox.tradeshift.com/tradeshift/rest";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api-sandbox.tradeshift.com/tradeshift/external/rest
    ...
    public <T> T deserialize(Response response, Type returnType) throws ApiException, IOException {
        ...
        if (contentType == null) {
            ...
            if (XML.toJSONObject(respBody).has("TaskList")) {
                ...
                return this.json.deserialize(((JSONArray) ((JSONObject) rootElement.get("Tasks")).get("Tasks")).toString(), returnType);
            }
        }
        if (isJsonMime(contentType)) {
